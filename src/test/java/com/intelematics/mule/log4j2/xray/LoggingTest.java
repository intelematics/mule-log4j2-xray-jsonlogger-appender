...
public class LoggingTest {
  ...
  public void testLogging() {
    ...
    XrayAppender.JsonLoggerClass = "com.intelematics.mule.log4j2.xray.LoggingTest";
    ...
    System.out.println("Completeed in ms"+ (Instant.now().getMillis() - now.getMillis()));
    XrayLogReceiver.getInstance("ap-southeast-2").stop();
    System.out.println("Stopped in ms"+ (Instant.now().getMillis() - now.getMillis()));
